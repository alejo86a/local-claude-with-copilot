...
This file is the project index for Markdown-based documentation. It references the core docs and locale copies so future agents can discover the relevant files quickly.
